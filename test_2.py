...
print("Выбери один из следующих товаров и укажи его номер: 1 - Sauce Labs Backpack, 2 - Sauce Labs Bike Light, 3 - Sauce Labs Onesie, 4 - Test.allTheThings() T-Shirt, 5 - Fleece Jacket, 6 - Brown T-Shirt")
product = input()
...
if product in xpathes:
    ...
    value_product_text = value_product.text
    print(value_product_text)
    value_price_product = driver.find_element(By.XPATH, "//*[@id='inventory_container']/div/div[1]/div[2]/div[2]/div")
    value_price_product_text = value_price_product.text
    print(value_price_product_text)
...
if product in cart_xpathes:
    ...
    cart_value_product_text = cart_value_product.text
    print(cart_value_product_text)

assert value_product_text == cart_value_product_text
...
cart_price_product_text = cart_price_product.text
print(cart_price_product_text)

assert value_price_product_text == cart_price_product_text
...
# FINAL CART INFO, CHECK VALUE AND PRICE
finish_value_product = driver.find_element(By.XPATH, xpath)
finish_value_product_text = finish_value_product.text
print(finish_value_product_text)
assert value_product_text == finish_value_product_text
